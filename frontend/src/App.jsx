...
import Footer from "./component/Footer";     // ← Import here
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/registrationSearch" element={<RegistrationSearch />} />
        <Route path="/editregistration/:id" element={<RegistrationEdit />} />
        <Route path="/enquiry_form" element={<EnquiryForm />} />
        <Route path="/form_selector" element={<FormSelector />} />
